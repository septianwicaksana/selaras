...
const AppAside = () => {
  ...
  const asideShow = useSelector((state) => state.tabs.asideShow)
    ...
    >
      ...
      <CTabContent>
        <CTabPane visible={activeKey === 1}>
          <CListGroup flush>
            <CListGroupItem className="list-group-item border-start-4 border-start-secondary bg-light dark:bg-white dark:bg-opacity-10 text-center fw-bold text-medium-emphasis text-uppercase small">
              Today
            </CListGroupItem>
            ...
            <CListGroupItem className="border-start-4 border-start-secondary bg-light dark:bg-white dark:bg-opacity-10 text-center fw-bold text-medium-emphasis text-uppercase small">
              Tomorrow
            </CListGroupItem>
